...
// File: lib/screens/screen_13_tip.dart
/// Screen 13 — Tip Screen: Quick tip selection (₹10, ₹20, ₹40, ₹100, or No Tip) with 100% partner pass-through guarantee
class Screen13Tip extends StatefulWidget {
  const Screen13Tip({super.key});

  @override
  State<Screen13Tip> createState() => _Screen13TipState();
}

class _Screen13TipState extends State<Screen13Tip> {
  int _selectedTip = 20;
